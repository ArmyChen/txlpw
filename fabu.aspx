<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fabu.aspx.cs" ValidateRequest="false" Inherits="fabu" %>
            ...
            <table width="1000px" align="center">
                ...
                <tr>
                    ...
                    <td style="text-align:left; font-size:12px; color:black; padding:8px 5px 7px 0px;">
                        ...
                        <asp:Button ID="Button2" runat="server" Text="确认发布" OnClick="Button2_Click" />
