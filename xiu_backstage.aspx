<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiu_backstage.aspx.cs" ValidateRequest="false" Inherits="xiu_backstage" %>
    ...
    <script type="text/javascript">
        ...
        function add_bac(str,str1) {
            ...
            $.ajax({
                ...
                url: 'xiugai_ajax.aspx',
                data: { str: zhis, mid: str, bid: str1 },
                async: true,
    ...
    <div>
        <div style="padding: 10px; clear: both;">
                <div style="padding-bottom: 10px; clear: both; border-bottom: 2px solid #186a6d">
                    <span style="font-size: 12px;"><font face="宋体"><asp:Label ID="Label1" runat="server" Text=""></asp:Label> > 修改<asp:Label ID="Label2" runat="server" Text=""></asp:Label></font></span><input type="text" id="scz" style="display:none;" /><input type="text" id="mk" runat="server" style="display:none;" /><input type="text" id="qz" runat="server" style="display:none;" />
                </div>
