<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insertqx.aspx.cs" Inherits="insertqx" %>
...
<link href="css/mofei.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function djs(str1, str2)
        {
            if (str2 == "0")
            {
                if (document.getElementById("Label2").innerText.indexOf(str1) != -1) {
                    var zhi = str1 + ",";
                    var zhi1 = document.getElementById("Label2").innerText.replace(zhi, "");
                    document.getElementById("Label2").innerText = zhi1;
                }
                else {
                    document.getElementById("Label2").innerText += str1 + ",";
                }
            }
            else if (str2 == "1")
            {
        ...
        function qs() {
            ...
            if (zhi == "") {
                ...
                $.ajax({
                    ...
                    data: { id: $("#t1").val(), zhi: zhi, in1:$("#Label2").text(), up: document.getElementById("Label3").innerText, de: document.getElementById("Label4").innerText, se: document.getElementById("Label5").innerText, sh: document.getElementById("Label6").innerText, gj: document.getElementById("Label7").innerText },
                    async: true,
        ...
        function qs12321321()
        {
            ...
            else
            {
                ...
                xmlhttp.open("POST", "add_qx.aspx?zhi=" + escape(zhi) + "&in="+escape(document.getElementById("Label2").innerText)+"&up="+escape(document.getElementById("Label3").innerText)+"&de="+escape(document.getElementById("Label4").innerText)+"&se="+escape(document.getElementById("Label5").innerText)+"&sh="+escape(document.getElementById("Label6").innerText)+"&gj="+escape(document.getElementById("Label7").innerText)+"", true); //编译字符串，反乱码
            ...
            <div style="background-color:white;">
                <div style="border-top:4px solid #00a5a5;">
                    <div style="padding:9px 0px 10px 20px; border-bottom:1px solid #e5e5e5; clear:both;">
                        <span style="font-size:14px; color:#464646; vertical-align:middle;"><font face="微软雅黑"><b>新增权限组</b></font></span>
                    </div>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td class="oatd1">
                                            ...
                                            权限组名称：</td>
                                        <td class="oatd2">
                                            <input id="qxz" type="text" class="text1" />
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="oatd1">
                                    ...
                                    <tr>
                                        ...
                                        <td class="oatd2">
                                            <input type="button" class="button1" value="添加权限组" onclick="qs()" />
                                        &nbsp;&nbsp;
